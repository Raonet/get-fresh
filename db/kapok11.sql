...
CREATE TABLE `sys_dept`  (
  ...
  `leader` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '部门负责人',
...
-- ----------------------------
-- Table structure for sys_fresh
-- ----------------------------
DROP TABLE IF EXISTS `sys_fresh`;
CREATE TABLE `sys_fresh`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `ip` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'ip',
  `time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '时间',
  `city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '城市',
  `navigator` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '设备信息',
  `open` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '开关',
  `version` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'js版本',
  `click` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'js版本',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1656598447215 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_fresh
-- ----------------------------
INSERT INTO `sys_fresh` VALUES (1656826791133, 'http://192.168.0.100:9540', '110.87.131.128', '1656826791132', '福建省福州市', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.82 Safari/537.36', '1', '1', '点击');
INSERT INTO `sys_fresh` VALUES (1656826817259, 'http://192.168.0.100:9540', '110.87.131.128', '1656826817258', '福建省福州市', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.82 Safari/537.36', '1', '1', '点击');
INSERT INTO `sys_fresh` VALUES (1656835639933, 'http://localhost:8081', '110.87.131.128', '1656835639932', '福建省福州市', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.82 Safari/537.36', '1', '1', '点击');
INSERT INTO `sys_fresh` VALUES (1656839730828, 'http://localhost:8081', '110.87.131.128', '1656839730828', '福建省福州市', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.82 Safari/537.36', '0', '1', '点击');

-- ----------------------------
-- Table structure for sys_fresh_key
-- ----------------------------
DROP TABLE IF EXISTS `sys_fresh_key`;
CREATE TABLE `sys_fresh_key`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of sys_fresh_key
-- ----------------------------
INSERT INTO `sys_fresh_key` VALUES (1, 'SCT142886ThpZhT95vJTKYbwGFppWFoFRP');
...
INSERT INTO `sys_menu` VALUES (19, '钓鱼', '11111', 1, 0, 0);
INSERT INTO `sys_menu` VALUES (20, '列表', '1', 2, 0, 19);
...
INSERT INTO `sys_menu_perm` VALUES (25, 19, '/api/user', 'PUT');
INSERT INTO `sys_menu_perm` VALUES (26, 19, '/api/menu/all', 'GET');
...
CREATE TABLE `sys_post`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '岗位编码',
